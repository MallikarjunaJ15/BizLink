...
const Navbar = () => {
  ...
  const userNavLinks = user
    ? [...navLinks, { path: "/meetings/dashboard", label: "Meetings", icon: Video }]
    : navLinks;

  const isActive = (path) => location.pathname === path;

  return (
    <nav className=" bg-white/95 backdrop-blur-md border-b-2 border-[#8d99ae]/10 shadow-sm font-display rounded-2xl z-[9997]">
